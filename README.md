...
Contributor guidance, local build commands, and validation checks live in
[CONTRIBUTING.md](CONTRIBUTING.md). The public site is published at
[arch2.mlsysbook.ai](https://arch2.mlsysbook.ai).
