...
% This ensures consistency: callout-question -> callout_question
...
\begin{tcolorbox}[
  ...
  before upper={\IfStrEq{#1}{callout-question}{\itshape}{}},
  title=\hspace{3.25em}\protect#2\hspace{0.5em}{\protect#3}, % Brace #3 to protect commas in titles
