...
design-loop card, loop contract, environment contract, and evidence ledger are
...
Read the chapter as a stack. The architectural claim is the smallest reviewable object.
...
them: the architectural claim, architecture environment, method roles, evidence ledger,
