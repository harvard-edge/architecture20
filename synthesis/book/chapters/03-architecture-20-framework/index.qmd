...
After this chapter you can turn a prompt, paper, tool, or project into a
reviewable design-loop card. That means you can:

- write an architectural claim as a reviewable object: workload, baseline, design space, objectives, constraints, evidence, rejection authority, commitment boundary, and human decision;
