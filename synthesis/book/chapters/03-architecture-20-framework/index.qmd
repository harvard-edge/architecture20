...
```{=latex}
\abstract*{This chapter introduces how the book states and reviews architectural claims, along with its ontology and compact framework. Architecture 2.0 is the discipline of making architectural claims and their design loops explicit enough that AI systems can act inside them credibly.}
```
...
itself represent all of the state needed to synthesize systems. It can expose
