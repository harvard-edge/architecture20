...
boundary conditions.
The figure draws one agent to keep the contract legible. The same autonomy test
applies when the implementation uses several agents: every generated proposal,
