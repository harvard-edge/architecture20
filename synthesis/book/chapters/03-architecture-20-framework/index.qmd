# Design Loops for AI-Mediated Architectural Claims {#sec-architecture-20-ontology}
...
::: {.callout-question}
How can architectural claims, design spaces, and design loops be stated
explicitly enough for AI-assisted architecture work to be reviewable?
:::
...
Its test is whether it exposes enough state for an agent to act within bounds
...
**In the Lighthouse prompt.** If an agent claims that a "vector-capable CPU,
