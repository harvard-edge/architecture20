...
>
> — George E. P. Box, *Robustness in the Strategy of Scientific Model Building* (1979)^[**Author's Note:** This chapter introduces proxies and surrogate models. It acknowledges that while fast proxies are inherently inaccurate ("wrong"), they are absolutely essential for accelerating an AI agent's search ("useful").]
:::
