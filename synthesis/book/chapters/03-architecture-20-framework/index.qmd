...
[^fn-reinforcement-learning-c03]: **Reinforcement learning**: Machine learning where an agent learns to act in an environment so as to maximize a cumulative reward.
...
[^fn-surrogate-model-c03]: **Surrogate model**: A cheap predictive model trained to mimic a slower, more expensive simulator.
