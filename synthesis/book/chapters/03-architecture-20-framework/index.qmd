...
- **Reader test:** Can you review an architectural claim through the loop that
  produced it, its claim, environment, method roles, evidence ledger, rejection
  authority, and commitment boundary?
- **Next loop state:** The next chapter asks what representations and world models
  must encode before that loop can synthesize systems credibly.
:::
