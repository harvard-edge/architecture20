...
Asking whether a generative model can design hardware is too coarse a framing. The more
...
Current AI methods often discard the failure traces that teach human architects the true boundaries of a design space. A major open question is how to continuously extract and encode these negative paths into a rigorous representation of architecture state (see the discussion on "The Architecture 2.0 Ontology" in @sec-arch2-ontology) that actively regularizes generative models against out-of-bounds hallucinations and causal errors.
