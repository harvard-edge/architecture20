...
*(**Author's Note**: George E. P. Box, a British statistician who made major contributions to time-series analysis, famously noted that while all models are flawed, the good ones are practically useful. For us, this perfectly captures the role of proxies and surrogate models: while fast proxies are inherently inaccurate, they are absolutely essential for accelerating an AI agent's search.)* Computer architecture has always depended on disciplined abstraction. An
