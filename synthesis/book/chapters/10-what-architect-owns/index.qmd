...
Read @fig-architect-owned-boundary as an ownership boundary: the loop can automate work inside the
...
```yaml
#| lst-label: lst-redacted-trace
#| lst-cap: "**Redacted Negative Trace:** A YAML schema for sharing rejected design paths without disclosing proprietary physical design rules."
