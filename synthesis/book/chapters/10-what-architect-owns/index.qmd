...
Read benchmark examples by the loop fields they expose, not by their
names. ArchGym and QuArch, met earlier, contribute environment/action interfaces
...
work.
@tbl-architecture-20-design-principles collects each chapter's primary
principle as a review check and pairs it with the design challenge it leaves
behind; @sec-appendix-e-design-principles gathers the complete set, including
...
- **Next loop state:** These ownership skills are trainable, not innate;
  @sec-teaching-the-loop closes the book by turning them into what the field
  must teach.
:::
