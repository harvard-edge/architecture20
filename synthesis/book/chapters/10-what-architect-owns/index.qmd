# What the Architect Owns When Agents Act {#sec-what-architect-owns}
...
::: {.callout-question}
What remains nondelegable for the architect when agents, tools, and
environments can act inside the design loop?
:::
...
is a responsibility story about loops in which agents can act but cannot own
the commitment.
...
those consequences, and a tool-using agent can help surface them, but neither
...
diagnostic for loops where tools or agents can advance candidates faster than
