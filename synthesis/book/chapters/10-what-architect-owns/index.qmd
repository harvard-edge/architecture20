# What the Architect Owns {#chap-what-architect-owns}
...
Chapter 7 is exactly why the field needs reproducible, end-to-end benchmarks and
...
The operational checklist already exists. The trust checklist in Chapter 7 and
the design-loop card and rubric in Appendix
`\ref{chap-appendix-b-design-loop-card}`{=latex} give it for a single claim and
