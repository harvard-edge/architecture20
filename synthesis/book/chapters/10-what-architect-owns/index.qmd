...
A practical ownership test follows. If the loop is wrong, the review record
should show who defined the intent, who accepted the abstraction, who trusted the
evidence, who had authority to reject the result, who waived or escalated missing
evidence, and who accepted the final commitment. If those names disappear, the
loop has not become more advanced. It has only hidden the architecture decision.
