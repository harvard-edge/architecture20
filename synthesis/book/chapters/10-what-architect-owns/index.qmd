...
hidden failures, tool overfitting[^fn-overfitting-c10], or biased traces.
...
[^fn-overfitting-c10]: **Overfitting**: in machine learning, the tendency of a model to learn the noise or specific biases of its training data rather than the underlying generalizable patterns.
