...
*(**Author's Note**: Jan L. A. van de Snepscheut was a Dutch computer scientist and educator known for his work in computing science. This chapter traces a real end-to-end loop where an accelerator looks like a massive winner in a fast proxy ("theory"), but fails completely when evaluated in cycle-accurate simulation ("practice").)* The previous chapters have described what a credible loop must contain. They
