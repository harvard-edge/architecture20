...
>
> — Jan L. A. van de Snepscheut, Computer Scientist^[**Author's Note:** This chapter traces a real end-to-end loop where an accelerator looks like a massive winner in a fast proxy ("theory"), but fails completely when evaluated in cycle-accurate simulation ("practice").]
:::
