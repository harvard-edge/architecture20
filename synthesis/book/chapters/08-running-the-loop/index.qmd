...
frame time, an average-power check against the 3\ W envelope. It stands in for a memory-aware model: a dataflow analysis like
...
@tbl-worked-loop-ledger shows the evidence ledger left behind. Read the first
