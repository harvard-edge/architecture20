...
>
> — Edsger W. Dijkstra, *Notes on Structured Programming* (1970)^[**Author's Note:** This chapter focuses on verification gates—how we use tests not to prove an AI-generated design is perfect, but to aggressively reject the bad ones (the "red-teaming" approach).]
:::
