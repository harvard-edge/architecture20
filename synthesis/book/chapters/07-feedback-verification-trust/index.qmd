...
The failure an independent rejection authority most often has to catch is proxy mismatch[^fn-proxy-mismatch-c07]. A loop optimizes the measurement
...
[^fn-proxy-mismatch-c07]: **Proxy mismatch**: called specification gaming or reward hacking in the machine-learning literature [@AmodeiEtAl2016ConcreteProblems], it occurs when a method optimizes an imperfect proxy metric in ways that degrade the true, unmeasured objective; it is an instance of Goodhart's Law.
