...
Rejection authority is also the lever in the rejection-bound result of
...
3\ W envelope at the evidence level being used. A proxy or simulation-stage
result can advance the candidate, but it cannot erase unresolved
compiler/runtime viability, workload drift, thermal behavior, or
physical-design risk.

**Reader takeaway.** Treat ISA compatibility, power, deadline, and evidence
fidelity as rejection gates. If any gate is unsupported, the loop should reject,
revise, or escalate rather than turn a plausible subsystem into a commitment.
:::
...
As verification becomes AI-assisted, what would actually guarantee that a learned
rejection authority is independent of the generator it judges, rather than a
second opinion from the same witness with the same blind spots?
:::
