...
4. **Policy Boundaries:** Rejection occurs because the candidate fails fast structural checks (e.g., FIRRTL compilation passes) or information-flow/timing-channel security boundaries (e.g., GLIFT).
