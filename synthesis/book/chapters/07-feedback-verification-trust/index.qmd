...
::: {.column-margin}
**Author's Note:** This chapter focuses on verification gates—how we use tests not to prove an AI-generated design is perfect, but to aggressively reject the bad ones (the "red-teaming" approach).
:::
