...
is not made. That is the whole point of writing $\tau_k$ down per level: a missing
cell forces rejection or escalation, never silent commitment. And when a claim is
...
Two failure modes hide here, and they need different cures. A proxy can simply be
