...
```python
#| lst-label: lst-side-channel
#| lst-cap: "**Security Gate Check:** An illustrative Python snippet rejecting RTL candidates that share state across trust boundaries."
