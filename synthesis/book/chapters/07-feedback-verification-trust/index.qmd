# Feedback, Verification, and Trust {#chap-feedback-verification-trust}
...
Chapter 6 treated methods as roles inside a design loop. This chapter asks
...
> what they cost, how long they take, how reversible they are, and what level of
> decision they can support.
...
the connection to sample efficiency from Chapter 6: sample efficiency is not
...
or deployment experiment change a decision enough to justify its cost? Chapter 8
...
> **Rejection authority.** A credible Architecture 2.0 loop should name
> what can say no: at least one independent authority that can reject a candidate
> before the loop treats it as an architectural commitment.
...
instead of silently turning output into commitment. Chapter 8 runs this rule on
