...
> **Proxy mismatch and Goodhart's Law.** The proxy mismatch first named in @sec-architecture-environments-tool-interfaces is an instance of Goodhart's Law: when a measure becomes a target, it ceases to be a good measure. @sec-feedback-verification-trust treats it in full.
