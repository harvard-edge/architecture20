...
Hardware awareness is not the same as using hardware vocabulary. A generated
...
Sample efficiency^[Sample efficiency: A measure of how much data or how many environmental interactions an algorithm requires to reach a target level of performance. High sample efficiency means fewer expensive simulations are needed.] is one of the reasons architecture is a hard AI domain.
