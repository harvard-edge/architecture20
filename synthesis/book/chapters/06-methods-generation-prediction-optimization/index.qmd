...
After this chapter you can turn "we used method X" into a method-role receipt.
That means you can:

- match a method role (generate, predict, optimize, critique, repair, verify, or explain) to an architecture task;
- state a method claim as object, action, feedback fidelity, rejection condition, commitment boundary, and decision owner;
...
> object through this interface, receives this feedback at this fidelity, can be
> rejected by this evidence, and supports only this commitment level owned by
> this named decision owner.
...
The level label is not the claim. The claim is the method-role receipt the loop
can actually support: object, interface, feedback fidelity, rejection rule,
commitment boundary, and decision owner.
