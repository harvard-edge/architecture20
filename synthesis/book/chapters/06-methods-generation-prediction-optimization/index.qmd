# Method Roles Inside Agentic, Rejectable Architecture Loops {#sec-methods-generation-prediction-optimization}
...
::: {.callout-question}
How should method roles be matched to the task, feedback budget, and evidence
burden of an AI-assisted, rejectable architecture loop?
:::
...
Generation is the most visible AI role because fluent artifacts are easy to
...
For an agent, optimization is therefore not autonomous selection of the best
