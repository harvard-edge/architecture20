...
![**Method roles are useful only inside a represented loop:** Generation, prediction, optimization, critique, repair, and verification each need explicit state, feedback, and rejection.](images/F7-method-role-map){#fig-method-role-map width="100%" fig-alt="Role map showing generation, prediction, optimization, critique, repair, verification, and explanation as bounded method roles inside a represented architecture loop."}
