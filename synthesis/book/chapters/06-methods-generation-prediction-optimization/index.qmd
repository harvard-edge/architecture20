...
*(**Author's Note**: Lord Kelvin (William Thomson) was a British mathematician and physicist who contributed heavily to the laws of thermodynamics. This chapter covers search, reinforcement learning, and optimization. None of these AI methods work without a measurable objective function to provide a rigorous reward signal.)* feedback is observed. This chapter asks which methods belong inside that
