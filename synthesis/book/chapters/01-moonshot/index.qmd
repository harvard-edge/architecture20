...
::: {.callout-question}
How can Architecture 2.0 make the path from architectural intent to credible
system design inspectable for AI-assisted work, rather than treating AI as
prompt-to-chip generation?
:::
...
decision, because that is what another architect can inspect, reject, and
improve.
:::
