...
[^fn-pareto-front-c01]: **Pareto front**: In multi-objective optimization, the set of designs for which no objective can be improved without making another worse.
