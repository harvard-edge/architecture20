...
| Design-space report with evidence and rejected alternatives | Alternatives, Pareto fronts, assumptions, uncertainty, verification plan, negative traces, and human decision points. | Evidence chain, meaning a connected record of measurements, assumptions, checks, and rejections; coverage; rejected candidates; reproducible artifacts; and explicit rejection authority before higher commitment. |
...
- Architecture 2.0 is about designing the design loop, not prompt-to-chip automation.
- The lighthouse prompt is a stress test for hidden architecture state.
- AI methods play bounded loop roles: generate, predict, optimize, critique, verify, and coordinate.
- Efficiency is multidimensional and includes evidence cost.
- Human architects still own intent, evidence standards, rejection, and commitment.
:::
