...
compute organization bounds for the agent's action space. "3\ W TDP target in a 3\ nm-class LP mobile
process" sets the physical-design envelope that can reject an agent's proposal, and "design-space report
