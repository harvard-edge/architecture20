...
read, not as problems this chapter solves.
...
2. When the strongest evidence, such as real traces, RTL, or silicon, is scarce
   or proprietary, what cheaper evidence is enough to reject a bad candidate
   before committing to it?
3. What should an AI method be allowed to decide on its own, and what must stay a
   human decision, for the result to remain trustworthy?
4. What would *engineering best practices* even mean for AI-assisted design loops,
