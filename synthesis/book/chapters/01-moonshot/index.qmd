...
**Reader takeaway.** Treat the prompt as a recurring stress test: if a proposed
loop cannot say what it represents, what it may change, what evidence it
records, what it rejects, and who decides, it has not yet answered the prompt.
:::
...
method tomorrow, and which would you keep under human rejection authority, and
what evidence would have to exist before you moved a decision across that line?
:::
