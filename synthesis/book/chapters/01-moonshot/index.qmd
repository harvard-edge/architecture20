...
> **Architecture 2.0.** Architecture 2.0 is the discipline of designing not only
> computing systems but the design loops that produce them, so that AI-assisted
> architecture claims can be made credible, comparable, and reviewable.
> Concretely, the architect designs, represents, instruments, and governs the
> loop itself so that AI systems can play bounded method roles, generation,
> prediction, optimization, critique and repair, verification, explanation, and
> coordination, all under explicit evidence standards and human decision
> authority.
