...
To map this intuition, @fig-loop-pattern-spectrum gives the chapter's spectrum. The
...
Consequently, @fig-domain-specificity-shapes should be read as a checklist
...
To link these constraints, @fig-codegen-narrow-waist makes the implication architectural. Code generation is the narrow waist of specialization. Above the waist are
...
To manage this co-evolution, @fig-hardware-software-coevolution shows the loop discipline this requires. The
