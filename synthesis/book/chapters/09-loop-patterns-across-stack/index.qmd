...
contract; a loosely coupled accelerator adds an interface and data-movement
obligation; a shared-memory SoC block changes integration and coherence
assumptions.
...
::: {.callout-lighthouse title="An ISA fragment is a software contract"}
