...
If you look closely at this space through the lens of a Joel Emer-style taxonomy, you realize we aren't just categorizing tools—we are categorizing the structural shape of the feedback loops. The ontology (State, Action, Environment, Rejection) defines what things are. A taxonomy defines how they are structured. When reading a new paper at ISCA, don't just ask "what layer of the stack is this?" Ask "which branch of the loop taxonomy does this fall into?" This gives you a structural lens to evaluate its failure modes.
:::
