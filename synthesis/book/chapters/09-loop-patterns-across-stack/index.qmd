...
[^fn-service-level-objectives-c09]: **Service-level objectives (SLOs)**: target values for system reliability and performance, commonly used to manage operational tradeoffs.
