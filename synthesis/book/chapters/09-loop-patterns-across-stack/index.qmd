...
fig, ax = plt.subplots(figsize=(4.95, 2.95))
fig.subplots_adjust(left=0.12, right=0.78, top=0.92, bottom=0.30)
...
legend = ax.legend(loc="upper left", fontsize=6.0, frameon=False, handlelength=1.6, borderpad=0.1, labelspacing=0.3)
for text in legend.get_texts():
    text.set_color(COLORS["ink"])

add_note_box(fig, "LogCA (Altaf & Wood, ISCA 2017): the farther the accelerator from the host,\nthe larger the granularity needed before offload even breaks even.", xywh=(0.12, 0.03, 0.66, 0.12), fontsize=5.5)
