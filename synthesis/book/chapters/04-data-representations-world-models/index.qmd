# Data, Representations, and Architecture World Models {#chap-data-representations-world-models}
...
Chapter 3 defined the ontology. This chapter deepens its first technical
...
for y, row in enumerate(rows):
    ...
    ax.text(1.04, y, row["right_label"], transform=ax.get_yaxis_transform(), ha="left", va="center", fontsize=6.8, fontweight="bold", color=COLORS["ink"], clip_on=False)
...
contested on its baselines and reproducibility (Chapter 7)
...
Chapter 6 returns to sample efficiency from the method side. The representation
...
> **Architecture world model.** An architecture world model is the loop's
> belief about how actions change architecture state and outcomes, including
> dynamics, costs, constraints, invalid-action rules, uncertainty, and decision
> policies.
...
Chapter 5 takes the next step. Once state is represented, tools can become
