...
> **Architecture world model.** An architecture world model[^fn-world-model-c04] is a *predictive design-space surrogate* that estimates physical reality. It embodies the loop's
...
::: {.column-margin}
✒︎ **Author\'s Note: The Un-rerunnable Result**
