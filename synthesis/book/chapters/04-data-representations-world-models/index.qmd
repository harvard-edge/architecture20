...
$$
<!-- TODO(vijay-data): replace the ~1e9 Wikipedia-corpus anchor with the exact measured token count from your Wikipedia data. -->
...
The literature cross-check is an intuition-scale receipt, not a measured corpus inventory; the Wikipedia-corpus anchor is the concrete estimate.
