...
related lesson: shared, cheaply scoreable examples can move a whole field. The
Architecture 2.0 version is not to seek a cheap labeled row,
...
- **Next loop state:** Once that state exists, tools can become environments that
  ...
  in Architecture 2.0: constrained agentic action under human-auditable
  authority.
:::
