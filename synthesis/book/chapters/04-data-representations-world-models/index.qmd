...
- **Reader test:** Could another team replay both the winning and the rejected
...
- **Next loop state:** Once that state exists, tools can become environments that
  act on it and return interpretable feedback, which is the point of
  representation in Architecture 2.0, constrained agentic action under
