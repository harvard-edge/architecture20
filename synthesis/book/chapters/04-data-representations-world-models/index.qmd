...
::: {.callout-design-principle title="Make architecture work legible"}
...
What incentive or tooling would make the field capture and share negative
traces, tool provenance, and loop state by default, when papers preserve only
winners and the most valuable records are proprietary or tacit, and would that
legibility change which architecture problems become AI-addressable?
:::

::: {.callout-carry-forward}
- **Principle:** *Make architecture work legible* (stated in full earlier).
