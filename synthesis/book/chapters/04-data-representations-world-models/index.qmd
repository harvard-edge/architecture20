...
>
> — Ludwig Wittgenstein, *Tractatus Logico-Philosophicus* (1922)^[**Author's Note:** An AI agent can only optimize what it can represent. If a hardware description language lacks the vocabulary for a novel concept, the generative AI is completely blind to it.]
:::
