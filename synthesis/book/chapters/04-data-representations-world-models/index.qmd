...
is a useful stress test for this chapter. It bridges two representation layers,
architecture knowledge that can be asked about in text and architecture state
that must be carried by a loop before an agent can act. The later QuArch reasoning benchmark makes the
