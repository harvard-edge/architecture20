# Architecture Environments and Tool Interfaces {#chap-architecture-environments-tool-interfaces}
...
Chapter 4 argued that a loop can only act on what it represents. This chapter
...
top_log_axis(
    ax,
    xlim=(5e-4, 7e7),
    xticks=[1e-3, 1, 3600, 86400, 604800, 31536000],
    xticklabels=["1 ms", "1 s", "1 h", "1 d", "1 wk", "1 yr"],
...
from this chapter to Chapter 7.
...
feedback, and rejection. Once that happens, Chapter 6 can ask which methods
