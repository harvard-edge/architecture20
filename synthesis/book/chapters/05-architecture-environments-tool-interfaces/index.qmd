# Architecture Environments for AI-Assisted Design Loops {#sec-architecture-environments-tool-interfaces}
...
::: {.callout-question}
How do tools become architecture environments for AI-assisted design loops when
their interfaces define legal actions, observable feedback, costs, and
rejection authority?
:::
...
For an agentic loop, these stages are progressively stronger rejection
authorities that decide whether a generated candidate deserves another sample,
