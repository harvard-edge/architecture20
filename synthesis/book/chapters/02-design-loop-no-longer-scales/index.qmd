...
::: {.callout-question}
Why do classical architecture loops strain when design choices, constraints,
and evidence demands grow faster than the loop's ability to evaluate, reject,
revise, and commit responsibly?
:::
