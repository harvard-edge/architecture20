# When Classical Architecture Design Loops Break {#chap-design-loop-no-longer-scales}
...
Chapter 1 named Architecture 2.0 as a discipline for designing the design loop
...
Chapter 1 made the Architecture 1.0 to Architecture 2.0 loop shift visible in
...
Chapter 1 made its north star. The binding constraint differs across scales,
...
too wide, and when to escalate to stronger evidence. Chapter 4 turns that
intuition into sample-cost and simulation-time representations, Chapter 5
separates feedback regimes by latency, fidelity, and rejection authority, and
Chapter 6 returns to this same count in an evidence-gap plot that compares
