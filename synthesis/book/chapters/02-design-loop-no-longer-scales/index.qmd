...
them, as visualized in @fig-scissors-gap-intro.
...
The scissors gap shown in @fig-scissors-gap-intro is not solely a hardware problem. Specialization also exposes a software obligation. It is one thing to build an
