...
:::: {.callout-lighthouse title="The compute-organization choice is already a schedule"}
**Reader takeaway.** The 12,960-state count is not search-space trivia. In the
Lighthouse slice, the CPU/accelerator/SoC choice also fixes interfaces, memory
paths, compiler/runtime assumptions, physical constraints, and an evidence
schedule: which states get cheap proxies, which get simulation, which escalate,
and which rejected regions are preserved.
::::
