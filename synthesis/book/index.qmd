...
<img class="book-cover" src="assets/images/arch2-cover.svg"
     alt="Architecture 2.0 cover: Agentic Design Loops for Computing System Synthesis">
```
:::
...
The book calls that broader act *system synthesis*: turning intent into
...
give those questions reusable names: system synthesis, loop contracts,
architecture environments, method roles, evidence ledgers, rejection authority,
commitment boundaries, evidence packets, and design-loop cards. The
...
@sec-moonshot runs through the book as a shared example. The book serves several
...
resource catalog in @sec-appendix-c-resource-catalog plus the living directory
...
especially grateful to Siddharth Garg (NYU), Brian Hirano (Micron), Jenny Huang
...
Lowe-Power (UC Davis), Martin Maas (Google DeepMind), Matt Sinclair (University
