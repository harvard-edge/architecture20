...
![**Architecture study evidence chain.** The physical linkage between Claim, Evidence, Check, and Accountable Decision.](images/FB-1-claims-evidence-checks.svg){#fig-claims-evidence-checks width="100%" fig-alt="**Architecture study evidence chain.** The physical linkage between Claim, Evidence, Check, and Accountable Decision."}
...
The machine schema uses the key `checks` to denote
