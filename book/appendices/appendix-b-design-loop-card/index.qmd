...
- **3. Checks/Decision Rights (`checks`, `decision_rights`):** This is a lightweight adaptation of formal Verification and Validation (V&V) standards (like DO-178C in aerospace or ISO 26262 in automotive) applied to AI-assisted architecture, so no automated action bypasses a recorded human decision.
