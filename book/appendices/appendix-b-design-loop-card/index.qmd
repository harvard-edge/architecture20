...
The human-facing card keeps twelve review fields. Before execution, a study
owner can use them to bound the work and state the proposed claim. During
execution, the owner adds evidence, failed or rejected work, and rejection-check
results. At review, the owner records the supported claim boundary and
accountable decision. Schema 2.0 represents some fields with more than one
machine key because claim support and decision authority require separate
records rather than a single prose string.
...
links among records, or exchange the card across tools. The outline below shows
the required structure without repeating every conditional rule.
...
reference integrity. They do not decide whether the linked evidence supports
the statement.
