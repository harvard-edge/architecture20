...
The design-loop card is a record of an AI-assisted architecture study, but the study itself is only one part of the architecture lifecycle. However exhaustive the study, its result is still a proxy that must survive the physical-design flow.
