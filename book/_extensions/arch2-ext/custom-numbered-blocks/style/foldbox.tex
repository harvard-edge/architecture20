...
\newenvironment{fbx}[3]{%
\csname mfxInCallouttrue\endcsname% confine in-callout longtables to tabular
\begin{tcolorbox}[
  enhanced jigsaw,
  breakable,
  ...
  overlay={
      \node [left,outer sep=0em, black,draw=none,anchor=west,
        ...
        at ([xshift=4.2mm]frame.west) {\fbxIncludeIcon{#1}{5.6mm}};
    },
  },
  ...
  before upper={%
    \IfStrEq{#1}{callout-crux}{\itshape}{}%
    \IfStrEq{#1}{callout-war-story}{\setlength{\parskip}{0.55\baselineskip}}{}%
  },
  title={\hangindent=2.8em\hangafter=1\hspace{2.8em}\protect#2\hspace{0.5em}{\protect#3}}, % hanging indent keeps wrapped title lines clear of the icon; brace #3 to protect commas
...
\newenvironment{fbxSimple}[3]{\csname mfxInCallouttrue\endcsname\begin{tcolorbox}[
  enhanced jigsaw,
  breakable,
  before skip=8pt,  % space above box (increased)
  after skip=8pt,   % space below box (increased)
