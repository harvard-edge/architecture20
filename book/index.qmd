...
and shared workloads, rules, and provenance from benchmarking. It also adapts
first-principle methods from more distant fields, such as state estimation from
control theory, the practice of inferring a system's hidden internal state from
noisy measurements.
