...
- explain when architecture loops become rejection-bound after generation gets cheap;
...
or physical-design evaluation, the architect must review the retained evidence
and authorize that expenditure. The new observation then returns to a separate
commitment gate. Costlier feedback does not authorize a larger commitment by
itself.
:::
...
maps to evidence and negative traces; and rejection authority maps to its own
card field. The commitment boundary and human decision separately record what
may advance and who owns that judgment.
...
rejection-bound. If the loop keeps committing without restoring that balance, it
