...
With those terms fixed, we can read the lighthouse prompt as more than a compact design request. A smaller sandbox prompt can still serve as an optional local-training exercise:
