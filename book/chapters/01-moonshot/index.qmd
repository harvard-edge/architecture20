...
**The challenge.** Independent groups could not reproduce the advantage. A 2023 reassessment with open code and shared testcases found that a strong simulated-annealing baseline matched or beat the method's own proxy cost on most modern testcases, that commercial and analytical placers often produced substantially lower routed wirelength, and that the method's proxy cost correlated only weakly with the metrics that decide a real chip [@ChengEtAl2023AssessmentRL].
