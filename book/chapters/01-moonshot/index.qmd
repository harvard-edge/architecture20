...
With those terms fixed, we can read the lighthouse prompt as more than a compact design request. A smaller sandbox prompt is still useful for learning to code an agentic loop locally:
