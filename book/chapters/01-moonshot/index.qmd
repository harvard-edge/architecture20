...
fragment throughout the book. @fig-moonshot-prompt keeps it visible as an object
of analysis. The top panel restates the prompt; the middle panel names the
...
paths together. @tbl-moonshot-decomposition keeps that obligation compact, a
...
@fig-architecture-development-triad visualizes why an
