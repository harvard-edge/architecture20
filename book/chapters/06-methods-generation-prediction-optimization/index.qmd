...
::: {.column-margin}
**Author's Note:** Lord Kelvin, the pioneering British mathematician and physicist, emphasized that measurement is the prerequisite for improvement. For our purposes, any AI-assisted method that influences an architecture decision needs observable feedback. Search and reinforcement learning need measurable objectives or rewards; critique, repair, and explanation need evidence that can reject or bound their outputs.
:::
