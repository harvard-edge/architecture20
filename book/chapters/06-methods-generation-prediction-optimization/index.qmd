...
## Define Roles and Feedback Budgets
...
## Match AI Roles to the Architecture Bottleneck
...
## Compare Method Roles by Level of Trust
...
## Generate Candidates and Proposals
...
## Predict Behavior Before Full Evaluation {#sec-prediction-estimating-behavior-before-full-evaluation}
...
### Allocate the Feedback Budget {#sec-sample-efficiency-under-expensive-feedback}
...
## Critique, Repair, and Verify Artifacts
...
### Critique Assumptions and Evidence
...
## Explain and Coordinate the Design Loop
...
## Choose One Model, Specialists, or a Hybrid System {#sec-one-model-specialists-hybrid}
...
## Compose Roles Under Study Constraints {#sec-choosing-a-method-under-constraints}
...
Tools: open-source simulation and synthesis, followed by physical implementation. Feedback and retries: failures and constraints prompt revisions. Evaluation: the artifact reaches tapeout. Lesson: human-model-tool iteration should not be mislabeled as an autonomous multi-agent architecture system [@BlockloveEtAl2023ChipChat].
