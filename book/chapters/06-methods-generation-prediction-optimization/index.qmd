...
[^fn-stats-conformal-prediction]: Conformal prediction is a statistical technique that wraps any model to produce rigorous, distribution-free uncertainty bands around its predictions. Here it turns a surrogate's point estimate into a calibrated interval the loop can act on, and only to prune, defer, or escalate, not to make an unowned commitment.
