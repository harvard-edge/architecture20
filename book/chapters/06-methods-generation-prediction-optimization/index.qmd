...
We apply **Reinforcement Learning (RL)** for combinatorial, sequential tasks like macro floorplanning. In these sequential tasks, the architect must tightly control the reward function, tying it directly to physical metrics such as routing congestion and thermal hotspots. These methods are resource managers orchestrated by the architect. They do not invent the design; they choose *where* to spend the next simulation run.
