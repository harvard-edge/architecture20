...
appropriate. Conformal prediction[^fn-stats-conformal-prediction] can wrap a surrogate, regardless of its
internals, so that it emits calibrated prediction sets, intervals with marginal
coverage at a user-chosen probability under an exchangeability
assumption[^fn-stats-exchangeability] [@AngelopoulosBates2021Conformal]. Architecture loops must audit
