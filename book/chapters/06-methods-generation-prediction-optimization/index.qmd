...
Coordination routes state, tasks, and artifacts when work crosses several tools or roles. Rather than viewing the coordinator as a simple shell script, architects should treat it as an *architectural control plane*, functioning much like Kubernetes does for cloud microservices. The coordinator monitors the desired state of the study, measures the actual state (tool outputs), and issues compensating actions.
