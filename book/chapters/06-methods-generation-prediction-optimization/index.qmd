...
::: {.column-margin}
**Author's Note:** Box's famous aphorism provides the discipline for AI methods in architecture. Because all models—generators, predictors, and optimizers—are inherently flawed, a method role is only useful when the loop can measure, reject, or bound its output. Search and reinforcement learning need measurable objectives; critique and repair need evidence that can reject their claims.
:::
