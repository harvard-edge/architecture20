...
To make sense of these options, we must draw a strict line: **A role is the *job description*; the method is the *tool* we hire for the job.** While roles stay the same, the methods we use depend on the specific hardware or software problem.
