...
::: {.epigraph}
> *A method role is only useful when the loop can measure, reject, or bound its output.*
>
> — Architecture 2.0, *Method Selection Discipline* (2026)
:::

::: {.column-margin}
**Author's Note:** Measurement is not enough, but observable feedback is the boundary between useful method roles and method claims that cannot be trusted. Search and reinforcement learning need measurable objectives or rewards; critique, repair, and explanation need evidence that can reject or bound their outputs.
:::
