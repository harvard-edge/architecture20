...
4. **How can a predictor keep calibrated coverage when architecture workloads, tools, and process corners break the exchangeability that conformal and other interval methods assume, and how should a study detect that coverage has lapsed before a decision relies on the interval?**

5. **How can role compositions change as software, workloads, tools, and deployed hardware evolve without invalidating old traces or silently shifting the study objective?**
