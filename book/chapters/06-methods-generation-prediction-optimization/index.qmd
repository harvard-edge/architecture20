...
- Match specific AI methods to the distinct architectural bottlenecks they are best suited to resolve.
- Treat AI-generated proposals as estimates until they are verified by physical simulators.
- Constrain the AI's action space to match the verification capabilities of available EDA tools.
- Orchestrate tool handoffs to preserve independent checks and maintain the architect's authority.
:::
