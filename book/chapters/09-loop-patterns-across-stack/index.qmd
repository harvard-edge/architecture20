...
When an optimizer tunes against a local proxy such as core area, check whether the harness includes checks for candidates that win only by pushing complexity into memory traffic, compiler support, verification, or SoC integration.
:::
...
High-consequence work includes RTL changes, physical design, timing closure, power analysis, and formal signoff. Feedback is delayed and reversal is slow and expensive. A passing early check cannot authorize a difficult-to-reverse transition.
