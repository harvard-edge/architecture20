...
rejection can be applied, not by how fast candidates can be produced. That claim
is the book's compact limit, the point where the preceding vocabulary becomes
measurable rather than only descriptive. The interface speedup form
