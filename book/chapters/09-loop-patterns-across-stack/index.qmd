...
::: {.callout-war-story}
**Strong gates, privately held.** This regime has strong rejection authorities, and the AlphaChip story is not a case of missing gates. Both the original team and its critics had serious ones: synthesis, timing, power, layout rules, and expert review. Each side could reject a candidate inside its own flow with real authority [@MirhoseiniEtAl2021GraphPlacement; @ChengEtAl2023AssessmentRL].

**No authority they shared.** What the field lacked was a rejection authority both sides accepted. A candidate that failed in the critics' flow was not evidence to the original authors, who could answer that the method had not been run as published, and a candidate that passed in the authors' flow was not evidence to the critics, who ran different baselines and testcases [@GoldieEtAl2024ThatChipHasSailed]. Strong private gates on both sides still could not settle a public claim, because rejection authority that is not shared cannot adjudicate a disagreement.

**The last open beat.** This is the war story at its highest commitment: a silicon-facing result where the gates were strong but not common, so the loop could not close in public. It is the last thing the case is missing, and it points straight at what the final chapter argues the field must build, a shared way to release, replay, and reject an architectural claim.
:::
