...
For a fixed commitment target, an AI-assisted design loop's throughput is
bounded by its rejection capacity, not the AI's generation capacity. AI
candidate count is absent from the bound. The loop speeds up only when a cheap,
independent, trusted rejector discharges a larger fraction of AI-proposed
