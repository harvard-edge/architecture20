...
Compiler infrastructure gives a useful but limited analogy. MLIR, a compiler
infrastructure for representing operations, types, dialects, and legality
checks, made many compiler transformations inspectable
...
a paper uses an LLM[^fn-ml-llm], reinforcement learning[^fn-rl-reinforcement-learning], Bayesian optimization, a surrogate
...
[^fn-rl-reinforcement-learning]: A machine learning training method based on rewarding desired behaviors and punishing negative ones. The chapter's caution is that naming it as the method still hides the task, represented state, and rejection conditions the loop must expose.
