...
reject only widens the gap. The shorthand is simple and unforgiving. Generate
cheap, reject expensive. Once that becomes true, the architecture problem is no
longer how many candidates an AI system can imagine, but how many unsupported
claims the loop can dispose of before they consume scarce evidence or human
commitment.
