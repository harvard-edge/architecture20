...
summaries, compiler or runtime assumptions, and re-evaluation triggers. The
evaluation could replay historical workload changes and ask when a claim should
be maintained, weakened, or withdrawn. This turns workload characterization into
part of the evidence record, not a setup detail.
