...
**Theme: The Collapse of Human-Driven Search**

* How can we formally constrain surrogate-driven search algorithms to proactively prune physically unroutable architectural states without requiring cycle-accurate simulation?
* Can we isolate limiting physical bounds (e.g., thermal, routing) directly from low-fidelity state telemetry before invoking costly synthesis oracles?

**Theme: The Simulation Bottleneck**

* Under what mathematical bounds can an autonomous agent safely escalate from fast analytical proxies to expensive, cycle-accurate simulation only when rank-inversions are mathematically probable?
* How do we mathematically formalize the tradeoff between exploring novel architectures and the immense compute cost of simulating them?
