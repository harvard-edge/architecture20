...
#| fig-cap: |
#|   **Silicon release intervals are compressing.** Apple's M-series and NVIDIA's datacenter GPUs increasingly ship close together, shortening the hardware cycle relative to the software running on it. Labels give the month gap between consecutive announced parts.
#| out-width: "100%"
