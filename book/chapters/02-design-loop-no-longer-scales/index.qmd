...
Microarchitectural complexity is only the first layer. Specialization, and the composition of specialized blocks into a larger system, adds the next. A battery- and thermally limited mobile part and a warehouse-scale system bounded by power delivery and total cost of ownership (TCO) demand different measures of efficiency [@BarrosoHolzleRanganathan2019DatacenterAsComputer], so specialization changes both the metrics that matter and the number of choices the architect must evaluate.
