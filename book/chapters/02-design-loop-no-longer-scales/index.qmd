...
For the lighthouse prompt, the "64-bit RISC-V" constraint brings ABI, memory-model,
...
Identifying the limiting engineering pressure does not specify how an
AI-assisted study should connect its question, design state, allowed changes,
tool path, observations, evidence, and decision. @sec-design-loop-no-longer-scales diagnoses why work
stalls and where assistance may matter. @sec-architecture-20-ontology defines the bounded study
that keeps the work coherent.
