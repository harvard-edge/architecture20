...
sample cost as architecture data in the sense developed in
...
should be rejected. This extends the generalization problem raised in
...
universal rule. The provenance discussion in
@sec-provenance-coverage-and-negative-traces and the examples in
@tbl-negative-traces define the evidence such representations would need to
preserve.
