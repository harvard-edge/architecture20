...
Because architecture is a co-design problem, static RTL code is not enough. The AI agent must understand runtime execution. Traces, phase classifications (like SimPoint), and bottleneck graphs serve as the fundamental data representations of the software target. The AI must be able to ingest and reason about workload state just as fluently as it does design state, matching the hardware mechanisms to the dynamic phase behavior of the target application.
