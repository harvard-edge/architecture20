...
**Theme: Multi-Modal State Representation**

* How can joint logical-spatial embeddings map 1D sequence delays and 2D routing constraints into a unified latent space without destroying structural fidelity?
...
**Theme: Modeling Failure and Drift**

* How can conformal prediction bands adapt dynamically to detect parametric constraint drift before a surrogate model confidently generates unroutable silicon?
