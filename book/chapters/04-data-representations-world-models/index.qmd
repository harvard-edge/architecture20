...
Regardless of the fidelity of the prediction or the cost model used, the Architect's Pivot remains mandatory. The AI's predicted consequence is strictly a search heuristic to prune the design space. Before any architectural claim is accepted, the human architect must orchestrate the Evaluation Harness to validate the candidate against physical silicon constraints—such as routing congestion, PPA, and STA—serving as the ultimate judge of its physical correctness.
