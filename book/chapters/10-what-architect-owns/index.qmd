...
The larger research questions remain, but they are extensions of this packet
rather than a new framework: how to audit redacted loop ledgers without revealing
design state, how to make negative traces reusable without turning local failures
into universal rules, how to represent selected tacit constraints without
pretending all judgment can be automated, how to preserve human stop authority in
long-horizon multi-agent loops, and how to maintain these artifacts after tools,
workloads, models, and owners change. @sec-appendix-c-architecture-20-resources
points to the live resource registry and missing infrastructure that can support
that agenda.
