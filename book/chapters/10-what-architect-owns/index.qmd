...
## Infrastructure Agenda for Architecture 2.0
...
forming a new framework. They ask how to audit redacted loop ledgers without
revealing design state, how to make negative traces reusable without turning
local failures into universal rules, how to represent selected tacit constraints
without pretending all judgment can be automated, how to preserve human stop
authority in long-horizon multi-agent loops, and how to maintain these artifacts
after tools, workloads, models, and owners change.
...
::: {.callout-architect-checkpoint title="The Field Agenda"}
