...
evaluation:
  ...
  disclosure:
    class: "redacted_proprietary_flow"
    reviewer_role: "artifact_committee_or_independent_auditor"
...
| **Telemetry coverage** | Hardware stepping, software stack, fleet cohort, sampling policy, privacy filter, canary or rollback label, and incident context when field evidence is used. | Prevents deployment evidence from being read as cleaner or broader than it is. |
