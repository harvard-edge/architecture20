...
For example, an AI optimizing a Network-on-Chip (NoC) for latency might strip away essential decoupling queues. A high-level proxy simulator might report zero-cycle transfer times, yielding a perfect score, but physically synthesizing this design would result in routing congestion and timing violations because the proxy ignored hold-time constraints.
