...
![**Correlated errors vs. independent checks.** A correlated check shares the generator's blind spots. A physical simulator provides an independent, orthogonal modality shift.](images/ch7_independent_checks){#fig-independent-checks fig-pos="H" width="100%" fig-alt="Correlated Error vs Independent Modality Shift diagram"}
