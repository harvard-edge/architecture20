...
**The lesson.** This is proxy mismatch at full-flow scale, and it is why trust here is a staged property earned up a fidelity ladder, not a single score. An unverified proxy win is a reason to escalate, never a reason to commit. The dispute did not turn on whether the method was clever. It turned on whether the evidence it was graded against meant what everyone assumed, which is exactly the question this chapter asks of any loop.
:::
