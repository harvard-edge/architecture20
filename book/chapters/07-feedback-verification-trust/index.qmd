...
traces, simulation runs, synthesis results, human waivers, and rejection events
into a unified audit object. Its value would be measured by tamper detection,
replayability, and whether the checker prevents a candidate from exceeding the
commitment level supported by its evidence. The fidelity-ladder and commitment
sections, @sec-fidelity-ladders-and-evidence-ledgers and @sec-commitment-levels-and-reversibility, define the evidence boundary this
...
workload drift, compromised baselines, stale tool versions,
side-channel-sensitive metrics, or deceptive proxies into the design process.
...
flows, internal baselines, or deployment data that cannot be shared directly.
...
should state what a reviewer can verify, what remains private, and what kinds of
claims are too dependent on confidential evidence to support public commitment.
