...
::: {.callout-war-story}
**The proxy.** AlphaChip is one of the field's clearest recent cases of a cheap proxy rewarding the wrong thing. Its loop optimized a fast proxy cost, a stand-in for the metrics that actually decide a chip.
