...
Record what each result supports, what can overturn it, and which assigned role may approve the next transition. A strong result does not widen the claim or authorize action on its own.
:::
