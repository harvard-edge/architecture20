...
surrogate can rank candidates. A tool-using agent[^fn-ml-tool-using-agent] can call simulators and
...
**The claim.** AlphaChip is one of the field's clearest recent disputes over whether a cheap proxy rewarded the wrong thing. Its loop optimized a fast proxy cost, a stand-in for the metrics that actually decide a chip.
...
flows, licensed reports, PDK-bound evidence, internal baselines, or deployment
