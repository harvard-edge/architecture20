...
could see, IPC, and the leakage it could not, were different quantities. The
missing rejection gate, non-interference, not any single bug, was the price. It is
the accidental adversary above, run at industry scale for twenty years.
:::
