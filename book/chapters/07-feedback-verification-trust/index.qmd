...
**Theme: Automated Verification Collateral**

* How can generative models be algorithmically constrained to co-emit RTL and mathematically sound SystemVerilog Assertions that guarantee complete path sensitization without manual coverage tuning?
...
**Theme: Adversarial Resilience of Oracles**

* What invariant physical constraints must be embedded into surrogate EDA models to prevent RL agents from metric-hacking unmodeled routing and timing limits?
* How can we mathematically quantify proxy divergence from physical realization and embed this uncertainty into an agent's reward function?
