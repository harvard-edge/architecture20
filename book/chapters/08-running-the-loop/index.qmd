...
[^fn-ml-rl-agents]: Reinforcement learning agents learn to make decisions by taking actions in an environment to maximize cumulative reward. Here they are floated as one possible policy for deciding when the loop should escalate, reject, or request stronger checks under a multi-fidelity evidence budget.
