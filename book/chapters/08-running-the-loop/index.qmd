...
measurement. This specific scoring formula is used to prevent an agent from aggressively minimizing cycles by deploying massively oversized arrays that remain mostly idle, enforcing a penalty for wasted silicon area. Reporting cycles and utilization separately keeps the composite
