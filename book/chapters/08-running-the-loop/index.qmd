...
[^fn-ml-generative-method]: A generative method or model is an AI system trained to generate new data samples, such as hardware configurations, from a learned distribution. Here it plays the method role that seeds the three candidate organizations the proxy then screens.
