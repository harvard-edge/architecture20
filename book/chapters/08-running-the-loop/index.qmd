...
The residue, a filled design-loop card and replay receipt, records the task
boundary, the evidence level, the negative traces, the rejection authority, and
the next evidence owner. That receipt is what lets a second architect reconstruct
why the surviving candidate advanced, why the others did not, and what would
overturn the decision. A win with no reviewable residue is a claim no one else
can check.
