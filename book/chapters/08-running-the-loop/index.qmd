...
- Preregister simulation constraints and budgets before evaluation to prevent biased baselines.
- Separate the evaluation of the final architecture from the evaluation of the AI's contribution.
- Execute targeted contrasts to establish why an AI-proposed mechanism succeeds.
- Package the exact inputs, tool versions, and logs to ensure the study is fully reproducible.
:::
