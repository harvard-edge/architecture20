...
Before a recalibrated surrogate is trusted to steer a multi-million-dollar chip design, it can run silently alongside the human-led EDA flow, predicting outcomes without controlling the project. Architects measure its calibration against the ground-truth tools over thousands of commits until it has earned the authority to steer the search.
