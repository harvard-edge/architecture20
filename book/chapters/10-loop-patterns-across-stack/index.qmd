...
The frontier tells a sober version of that story. Measured in a precision-normalized way, the best parts gain only about 1.5-fold a year, well below the headline throughput numbers whose growth leans heavily on dropping to lower-precision arithmetic. A specialization win therefore has to survive an end-to-end accounting rather than a proxy peak.
