...
redaction boundary, and rejection authority. A strong contribution would define
this contract for a simulator, compiler, EDA flow, or deployment setting and
test whether another method can act in the same harness without private
