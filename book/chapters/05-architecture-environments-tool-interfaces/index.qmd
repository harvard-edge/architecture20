...
invalid-action rules, escalation policy, and human-review rules, which
...
expensive feedback buys stronger rejection authority. As visualized in @fig-fidelity-cost-confidence,
...
6. Define invalid-action semantics, such as an illegal parameter, noncompilable artifact, nonsynthesizable design, violated constraint, timeout, simulator crash, or unsupported workload.
7. Log provenance and negative traces, preserving tool versions, seeds, workload versions, failed candidates, rejected alternatives, and reasons for rejection.
