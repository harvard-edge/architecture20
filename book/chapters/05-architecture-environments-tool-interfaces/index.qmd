...
A minimal implementation record for such a harness might include:
...
> rejection reason; and accountable decision.
...
#| out-width: "92%"
#| fig-alt: "Horizontal range plot comparing representative turnaround ranges and shrinking sample budgets for feedback regimes from cheap proxies to silicon deployment, without treating cost or fidelity as automatic authority."
