...
: **Closed flows can still expose review contracts:** Architecture 2.0 should standardize receipts, field names, and review semantics around commercial EDA and foundry flows without pretending that vendor internals or protected design state become public. {#tbl-standardizable-proprietary-contract tbl-colwidths="[18,34,38]"}
