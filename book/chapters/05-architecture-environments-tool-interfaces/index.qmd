...
- **Up next:** Once the environment defines what action and feedback mean, the discussion of methods for generation, prediction, and optimization (see the discussion on "Method Roles: Generate, Predict, Optimize" in @sec-methods-generation-prediction-optimization) can ask which methods belong inside the loop.
:::
