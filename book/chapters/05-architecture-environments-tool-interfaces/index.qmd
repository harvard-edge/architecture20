...
That realism limits what Architecture 2.0 should try to standardize. The field
does not need a universal vendor API or an open substitute for every foundry
rule. It needs stable contract surfaces that let reviewers see what was changed,
what was observed, what stayed confidential, and what could reject the claim.
@tbl-standardizable-proprietary-contract states that split explicitly.
...
integrity record, redaction boundary, and rejection authority. A strong
