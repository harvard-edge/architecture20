...
header = """# Making Architecture Tools Usable by AI {#sec-architecture-environments-tool-interfaces}
...
Rather than providing raw Python code, we formalize this interaction as a standard algorithmic interface, drawing inspiration from frameworks like OpenAI Gymnasium but tailored for the unique constraints of hardware design [@TowersEtAl2023Gymnasium; @KrishnanEtAl2023ArchGym].
